...
COMMENT ON COLUMN app.question.created_by IS 'User or process who created the record.';
COMMENT ON COLUMN app.question.created_on IS 'Timestamp when the record was created.';
COMMENT ON COLUMN app.question.modified_by IS 'User or process who last modified the record.';
