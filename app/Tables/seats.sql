CREATE TABLE app.seats (
    ...
    CONSTRAINT fk_offered_seats_university_category FOREIGN KEY (university_category_id) REFERENCES app.university_category(university_category_id),
    CONSTRAINT fk_offered_seats_campus FOREIGN KEY (university_campus_id) REFERENCES app.university_campus(university_campus_id),
    CONSTRAINT fk_offered_seats_state FOREIGN KEY (state_id) REFERENCES app.state(state_id),
    CONSTRAINT fk_offered_seats_city FOREIGN KEY (city_id) REFERENCES app.city(city_id),
    CONSTRAINT fk_offered_seats_region FOREIGN KEY (region_id) REFERENCES app.region(region_id),
    CONSTRAINT fk_offered_seats_degree FOREIGN KEY (degree_id) REFERENCES app.degree(degree_id),
    CONSTRAINT fk_offered_seats_degree_level FOREIGN KEY (degree_level_id) REFERENCES app.degree_level(degree_level_id),
    CONSTRAINT fk_offered_seats_shift FOREIGN KEY (shift_id) REFERENCES app.shift(shift_id),
    CONSTRAINT fk_offered_seats_frequency FOREIGN KEY (frequency_id) REFERENCES app.frequency(frequency_id),
    CONSTRAINT fk_offered_seats_quota_type FOREIGN KEY (quota_type_id) REFERENCES app.quota_type(quota_type_id),
    CONSTRAINT fk_offered_seats_special_quota FOREIGN KEY (special_quota_id) REFERENCES app.special_quota(special_quota_id)
);
