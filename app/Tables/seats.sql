CREATE TABLE app.seats (
    ...
    weight_nature_science       NUMERIC(5,2),
    min_score_nature_science    NUMERIC(5,2),
    min_enem_score              NUMERIC(5,2),   
    ...
    CONSTRAINT fk_seats_university_campus FOREIGN KEY (campus_id) REFERENCES app.campus(campus_id),
